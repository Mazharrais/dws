  ...
  return (
    <div id="tech" className="mt-[4rem] mb-[6rem]">
      ...
      <div className="flex flex-col items-center mt-[4rem] space-y-10">
        {/* First Row of Icons */}
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-8 text-[#4B5563] gap-6 sm:gap-[2rem] md:gap-[2rem]">
          {[
            ...
            <div className="flex flex-col items-center hover:scale-110 transform transition-all duration-300" key={alt}>
              <img src={src} alt={alt} className="h-12 w-12 sm:h-8 sm:w-8" />
        ...
        {/* Second Row of Icons */}
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-8 text-[#4B5563] gap-6 sm:gap-[2rem] md:gap-[1.2rem]">
          {[
